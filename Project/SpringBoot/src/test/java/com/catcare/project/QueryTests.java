...
public class QueryTests {
    ...
    // Ubicación de las consultas realizadas:
    /*
     * 1. Cantidad total de tratamiento administrados en el último mes -> TratamientoService
     * 2. Cantidad de tratamientos por tipo de medicamento administrado en el último mes (tabla medicamento - cantidad) -> DrogaService
